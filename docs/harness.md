...
(the declarations lup ships), `src/inkwell/devtools/harness/content/`
(the ones only this repository has), `src/inkwell/devtools/harness/catalog.py`
...
`src/inkwell/devtools/harness/content/catalog.py`, which composes both
